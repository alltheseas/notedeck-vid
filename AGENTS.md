# egui-vid Agent Development Guidelines

Development standards for egui-vid, aligned with [emilk/egui](https://github.com/emilk/egui) conventions and [damus-io/notedeck](https://github.com/damus-io/notedeck) architecture patterns.
...
# 3. Run linter (warnings are errors)
cargo clippy -- -D warnings

# 4. Run tests
cargo test

# 5. For platform-specific changes, verify features compile
